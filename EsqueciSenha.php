            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <div class="mb-0">Esqueci a Senha</div>
                    </div>
                    <div class="card-body">
                        <form action="recoverPass.php" method="post" id="registriForm">
                            <h3 class="text-center mb-4">Esquecia a Senha</h3>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary" name="ChangePass" id="btnEnviar">Trocar Senha</button>
                            </div>
                        </form>

                        <div class="text-center mt-3">
                            <p class="small text-muted">
                                Caso lembre da senha, clique <a href="./index.php" class="text-primary">aqui</a>
                            </p>
                        </div>
                    </div>
                </div>
